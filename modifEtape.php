...
<html>
	...
	<body>
		...
		<div class="contenu">
			<form action="editEtape.php" method="GET">
				<?php
					...
					$tableauETAPE = mysql_fetch_array($resultETAPE, MYSQL_BOTH);
				?>
				<table style="width: 500px; margin: auto;">
					...
					<tr>
						...
						<td>
							<input name="ETPHREDEBUT" type="date" placeholder="jj/mm/aaaa hh:mm" value=<?php echo "$tableauETAPE[1]"; ?> style="width: 145px; color: #9bbb58;"/>
						</td>
					</tr>
					...
					<tr>
						<td>et</td>
						<td>
							<input name="ETPHREFIN" type="date" placeholder="jj/mm/aaaa hh:mm" value=<?php echo "$tableauETAPE[2]"; ?> style="width: 145px; color: #9bbb58;"/>
						</td>
					</tr>
